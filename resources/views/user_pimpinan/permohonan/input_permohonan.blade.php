...
@section('header')
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ route('pimpinan.permohonan') }}">Data Permohonan</a></li>
...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('pimpinan.permohonan.insert') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group mt-4">
                            <a href="{{ route('pimpinan.permohonan') }}" class="btn btn-dark btn-sm">Kembali</a>
