...
@section('header')
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="/pimpinan/permohonan">Permohonan</a></li>
                        ...
                        @if ($permohonans->berkas)
                            ...
                            <tr style="display: flex;">
                                <th style="border: none; width: 10vw;">
                                    <a href="{{ route('pimpinan.permohonan.view', $permohonans->id) }}" target="__blank" class="btn btn-block btn-info btn-sm btn-icon">
                                        <span>Lihat File</span>
                                        <i class="far fa-eye"></i>
                                    </a>
                                </th>
                                <th style="border: none; width: 10vw;">
                                    <a href="{{ route('pimpinan.permohonan.download', $permohonans->id) }}" class="btn btn-block btn-info btn-sm btn-icon">
                ...
                <table class="table">
                    <tr>
                        <th style="border: none">
                            <a href="{{ route('pimpinan.permohonan') }}" class="btn btn-dark">Kembali</a>
                            <a href="{{ route('pimpinan.permohonan.approve', $permohonans->id) }}" class="btn btn-success {{ $permohonans->id_status == '2' ? '' : 'disabled' }}">Approve</a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.formReject').on('submit', function(e) {
                ...
                $.ajax({
                    type: "GET",
                    url: "/pimpinan/permohonan/reject",
                    data: {
