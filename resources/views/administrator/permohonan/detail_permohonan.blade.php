                        ...
                        @if ($permohonans->berkas)
                            ...
                            <tr style="display: flex;">
                                <th style="border: none; width: 10vw;">
                                    <a href="/admin/permohonan/view/{{ $permohonans->id }}" target="__blank" class="btn btn-block btn-info btn-sm btn-icon">
                                        <span>Lihat File</span>
                                        <i class="far fa-eye"></i>
                                    </a>
                                </th>
                                <th style="border: none; width: 10vw;">
                                    <a href="/admin/permohonan/file/{{ $permohonans->id }}" class="btn btn-block btn-info btn-sm btn-icon">
                ...
                <table class="table">
                    <tr>
                        <th style="border: none">
                            <a href="/admin/permohonan" class="btn btn-dark">Kembali</a>
