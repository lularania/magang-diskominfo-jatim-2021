...
@section('title', 'Tambah User Pimpinan')

@section('header')
    <div class="col-sm-6">
        <h1>Tambah User Pimpinan</h1>
    </div>
    <div class="col-sm-6">
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><b>Tambah User Pimpinan</b></h3>
        </div>
        <div class="card-body">
            <form action="/admin/user/pimpinan/save" method="post">
                @csrf
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group mt-4">
                            <a href="{{ route('admin.user.pimpinan') }}" class="btn btn-dark btn-sm">Kembali</a>
