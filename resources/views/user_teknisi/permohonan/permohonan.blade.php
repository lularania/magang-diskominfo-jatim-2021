...
@section('header')
    ...
    <div class="col-sm-4">
        <form action="/teknisi/permohonan" method="get">
...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <a href="{{ route('teknisi.permohonan.add') }}" class="btn btn-dark btn-sm mb-3">Add</a>
                        ...
                        <tr>
                            ...
                            <td>
                                @if (substr($item->berkas, -3) == 'pdf')
                                    <a href="{{ route('teknisi.permohonan.view', $item->id) }}" target="__blank" style="color: #d0261f;">
                            ...
                            <td>
                                <a href="{{ route('teknisi.permohonan.detail', $item->id) }}" class="btn btn-sm btn-primary">Detail</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
